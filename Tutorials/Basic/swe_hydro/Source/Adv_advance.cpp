...
#pragma omp parallel
	...
	for (MFIter mfi(S_new, true); mfi.isValid(); ++mfi)
	{
        ...
        // *************
        // NOTE: this is the bit I need to change. Instead of using get_face_velocity, use the state vector to compute fluxes. Or work out how to calculate the MAC velocities and hack that.
        // *****************
